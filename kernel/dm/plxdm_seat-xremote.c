...
#include "plxdm_seat-xremote.h"
#include "plxdm_configuration.h"
#include "plxdm_x-server-remote.h"

/* 前向声明, 供 G_DEFINE_TYPE 宏使用 */
static void seat_xremote_init(SeatXRemote *obj);
static void seat_xremote_class_init(SeatXRemoteClass *klass);
static void seat_xremote_finalize(gpointer obj);
...
{
    /* PlexsDOS: parent chain-up skipped */
    GreeterSession *greeter_session = NULL;
