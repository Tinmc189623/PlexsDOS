...
#include "plxdm_seat-local.h"
#include "plxdm_configuration.h"
#include "plxdm_x-server-local.h"
#include "plxdm_wayland-session.h"
#include "plxdm_plymouth.h"
#include "plxdm_vt.h"
...
PLXDM_DEFINE_TYPE_GET_TYPE (SeatLocal, seat_local, SEAT_TYPE)
