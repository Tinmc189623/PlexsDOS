...
#include "plxdm_session-config.h"
#include "plxdm_display-server.h"
#include "plxdm_accounts.h"
#include "plxdm_x-authority.h"
#include "plxdm_logger.h"
...
void session_set_auth_service (Session *session, const gchar *auth_service);
