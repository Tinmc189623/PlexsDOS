...
/* Define to enable detailed check of directory size prediction */
/* #undef Libisofs_dir_rec_size_checK */

/* Define to use ACL capabilities */
/* #undef Libisofs_with_aaip_acL */

/* Define to use Linux chattr capabilities */
#define Libisofs_with_aaip_lfa_flagS /**/

/* Define to use XFS-style project id capabilities */
#define Libisofs_with_aaip_projiD /**/
