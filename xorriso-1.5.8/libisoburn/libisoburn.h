...
/** Set up isoburn_disc_get_msc1() to return a fabricated value.
    ...
    @param adr_mode Determines how to interpret adr_value and to set msc1.
                    ...
                    4= start lba of last session with volume id
                       given by adr_value
                    @since 1.5.8 :
                    5= start lba of last session with modification time
                       exactly as given by adr_value. adr_value is seconds
                       since 1970 GMT (i.e. time_t as decimal number string)
                    6= start lba of last session with modification time
...
/** Try whether the data at the given address look like a ISO 9660
    ...
    one string of text information or data can be retrieved too.
    @since 0.1.6
    @param d     The drive with the medium to inspect
...
/** Relaxed constraints. Setting any of the bits to 1 break the specifications,
    ...
    @param relax Bitfield:
          ...
          bit21= rrip_tf_y1900
                 ...
                 @since 1.5.8
          bit22= relaxed_vol_atts
                 Allow all characters to be part of Volume Id and Volume Set Id
                 in PVD which are normally restricted to d-characters.
                 This relaxation bit is set to 1 by default.
                 @since 1.5.8
          bit23= relaxed_nonvol_atts
                 Allow all characters to be part of other text fields in PVD
                 which are normally restricted to a-characters or d-characters.
                 @since 1.5.8
    @return 1 success, <=0 failure
*/
...
#define isoburn_igopt_relaxed_vol_atts    0x400000
#define isoburn_igopt_relaxed_nonvol_atts 0x800000
