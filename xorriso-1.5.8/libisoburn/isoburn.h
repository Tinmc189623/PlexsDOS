...
struct isoburn_imgen_opts {
    ...
    */
    ...
    /**
     * Allow all characters to be part of Volume Id and Volume Set Id in PVD
     * which are normally restricted to d-characters.
     */
    unsigned int relaxed_vol_atts :1;

    /**
     * Allow all characters to be part of other text fields in PVD which are
     * normally restricted to a-characters or d-characters.
     */
