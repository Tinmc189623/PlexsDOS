                                ...
                                int flag)
{
 ...
 iso_write_opts_set_relaxed_vol_atts(wopts, opts->relaxed_vol_atts);
 iso_write_opts_set_relaxed_nonvol_atts(wopts, opts->relaxed_nonvol_atts);
...
int isoburn_igopt_new(struct isoburn_imgen_opts **new_o, int flag)
{
 ...
 o->rrip_tf_long= 0;
 o->rrip_tf_y1900= 0;
 o->relaxed_vol_atts= 1;
 o->relaxed_nonvol_atts= 0;
...
int isoburn_igopt_set_relaxed(struct isoburn_imgen_opts *o, int relax)
{
 ...
 o->relaxed_vol_atts= !!(relax & isoburn_igopt_relaxed_vol_atts);
 o->relaxed_nonvol_atts= !!(relax & isoburn_igopt_relaxed_nonvol_atts);
 return(1);
}
 ...
 *relax= (!!o->omit_version_numbers)    | ((!!o->allow_deep_paths)<<1) |
         ...
         ((!!o->rrip_tf_long) << 20) |
         ((!!o->rrip_tf_y1900) << 21) |
         ((!!o->relaxed_vol_atts) << 22) |
         ((!!o->relaxed_nonvol_atts) << 23);
 return(1);
}
